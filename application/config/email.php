...
$config['smtp_user']        = 'aries.liburania@gmail.com';
$config['smtp_pass']        = 'liburania#7654321';
...
$config['debug_output']     = 'text/plain';                       // PHPMailer's SMTP debug output: 'html', 'echo', 'error_log' or user defined function with parameter $str and $level. NULL or '' means 'echo' on CLI, 'html' otherwise.
