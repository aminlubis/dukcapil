<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('pencarian/T_find_data/process')?>" enctype="multipart/form-data">
      <div class="row">
        <div class="pull-left">
            <button type="button" onclick="getMenu('pencarian/T_find_data')" id="btnSave" name="submit" class="btn btn-sm btn-danger">
