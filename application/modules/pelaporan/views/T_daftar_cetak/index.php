      ...
      <div class="col-md-12">
        ...
        <div class="form-group">
          <div class="control-label col-md-2">
            <div class="checkbox" style="margin-top: -5px">
              <label>
                <input name="checked_nama" type="checkbox" value="1" class="ace">
        ...
        <div class="form-group" style="margin-top: 3px">
          ...
          <div class="control-label col-md-2">
            <div class="checkbox" style="margin-top: -5px">
              <label>
                <input name="checked_tgl_lhr" value="1" type="checkbox" class="ace">
          ...
          <div class="col-md-2" style="margin-left: -15px">
              <div class="input-group">
                <input class="form-control date-picker" name="tgl_lhr" id="tgl_lhr" type="text" data-date-format="yyyy-mm-dd" value=""/>
                <span class="input-group-addon">
                  <i class="fa fa-calendar bigger-110"></i>
                </span>
              </div>
        ...
        <div class="form-group" style="margin-top: 3px">
          <div class="control-label col-md-2">
            <div class="checkbox" style="margin-top: -5px">
              <label>
                <input name="checked_proses" value="1" type="checkbox" class="ace">
                <span class="lbl"> Proses Status</span>
              </label>
            </div>
          </div>
          <div class="col-md-2" style="margin-left: -15px">
            <?php echo $this->master->custom_selection(array('table'=>'global_parameter', 'where'=>array('flag'=>'status_proses'), 'id'=>'value', 'name' => 'label'),'','status_proses','status_proses','chosen-slect form-control','','');?>
          </div>
