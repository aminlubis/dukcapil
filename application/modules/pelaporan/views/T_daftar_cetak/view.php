<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('pelaporan/T_daftar_cetak/process')?>" enctype="multipart/form-data">
      <div class="row">
        <div class="pull-left">
            <button type="button" onclick="getMenu('pelaporan/T_daftar_cetak')" id="btnSave" name="submit" class="btn btn-sm btn-danger">
  ...
  if(confirm('Apakah anda yakin akan melanjutkan Proses Pencatatan No Akta?')){
    $.ajax({
      ...
      complete: function(xhr) {     
        ...
        getMenu('pelaporan/T_daftar_cetak');
