...
<form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('kebencanaan/T_bencana/process')?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-md-7">
        ...
        <span style="margin-left: 5px; padding-bottom: 10px"><a href="#" onclick="getMenuTabs('kebencanaan/T_bencana/form_data_awal/<?php echo isset($value)?$value->id_bencana:''?>', 'tabs_load_content');"><i class="fa fa-refresh"></i> Refresh Google Map</a></span>
      </div>
    </div>

    <div class="form-group" id="address">
          <label class="control-label col-md-2">Provinsi <span class="required" aria-required="true"> * </span></label>
          <div class="col-md-3">
              <input class="form-control" id="administrative_area_level_1" disabled type="text" value="<?php echo isset($value)?$value->nama_prov:'' ?>" readonly/>
              <input type="hidden" name="provinsiHidden" value="<?php echo isset($value)?$value->provinsi:'' ?>" id="provinsiHidden">
          </div>
          <label class="control-label col-md-2">Kota / Kabupaten <span class="required" aria-required="true"> * </span> </label>
          <div class="col-md-3">
              <input class="form-control" id="locality" type="text" value="<?php echo isset($value)?$value->nama_kab:'' ?>"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Pilih Lokasi dari maps" value="<?php echo isset($value->longitude)?$value->longitude:''; ?>" disabled="true">
        </div>
        <label class="control-label col-md-1">Latitude
            <span class="required" aria-required="true"> * </span>
        </label>
        <div class="col-sm-2">
            <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Pilih Lokasi dari maps" value="<?php echo isset($value->latitude)?$value->latitude:''; ?>" disabled="true">
        </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8" style="margin-left: 7px; margin-bottom: 3px">
          <input type="text" name="wilayah_terdampak" id="form-field-tags" value="<?php echo isset($value)?$value->wilayah_terdampak:''?>" placeholder="Enter tags ..." style="display: none;"><br>
          <span>
            <address>
            Perhatikan contoh penulisan untuk wilayah terdampak!<br>
            Kab/Kota = Kab. Tangerang, Kecamatan = Kec. Pasar Kemis, Kelurahan = Kel. Kutabaru <br>
            Harus diawali dengan jenis wilayah nya dan dipisahkan dengan titik ( . ), lalu klik "Enter"
            </address>
          </span>
      </div>
    </div>
    ...
    <div class="row">
      <div class="form-group" style="margin-top: 3px">
        <label class="col-md-6"><b>1. Kronologis kejadian bencana</b></label>
      </div>
    ...
    <div class="row" style="padding-top: 10px">
      <div class="form-group">
        <label class="col-md-6"><b>2. Upaya pemerintah pusat/daerah</b></label>
      </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#zona_waktu_hidden').val( $('input[name="zona_waktu"]:checked').val() );

        $('input:radio[name="zona_waktu"]').change(function() {
          $('#zona_waktu_hidden').val( $(this).val() );
        });
