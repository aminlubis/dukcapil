    ...
    public function process()
    {
        ...
        {                       
            ...
            if(isset($_FILES['icon']['name'])){
                ...
                if( $id != 0 ){
                    $profile = $this->Tmp_apps_config->get_by_id(1);
            ...
            if(isset($_FILES['url_file_tutorial_apps']['name'])){
                /*hapus dulu file yang lama*/
                if( $id != 0 ){
                    $profile = $this->Tmp_apps_config->get_by_id(1);
                    if ($profile->url_file_tutorial_apps != 0) {
                        unlink(PATH_FILE_DEFAULT.$profile->url_file_tutorial_apps.'');
                    }
                }
                $dataexc['url_file_tutorial_apps'] = $this->upload_file->doUpload('url_file_tutorial_apps', PATH_FILE_DEFAULT);
            }
