    ...
    $('#form_Tmp_mst_role').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('setting/Tmp_mst_role?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_Tmp_mst_role" action="<?php echo site_url('setting/Tmp_mst_role/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('setting/Tmp_mst_role')" href="#" class="btn btn-sm btn-success">
