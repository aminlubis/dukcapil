	...
	function enableDemoAjax() {		
		...
		var demo_ajax_options = {
			 ...
			 'content_url': function(hash) {
				...
				if(path.match(/(\/template\/)(ace-ci\/)?/))
					return path.replace(/(\/template\/)(ace-ci\/)?/, '/template/ace-ci/'+hash.replace(/^page\//, '')+'?return=') ;
					//return path + "?" + hash.replace(/\//, "=");

				//if(path.match(/(\/template\/)(ace-ci\/)?/))
				//	return path.replace(/(\/template\/)(ace-ci\/)?/, '/template/ace-ci/'+hash.replace(/^page\//, '')+'') ;
					//return path.replace(/(\/template\/)(ace-ci\/)?/, '/template/ace-ci/'+hash) ;
